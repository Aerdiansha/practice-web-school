...
// query max nis dari query database ke variable
$queryNis = mysqli_query($connection, "SELECT MAX(nis) as maxnis FROM data_siswa");
// fecth data ke array 
$data = mysqli_fetch_array($queryNis);
// 
$maxnis = $data['maxnis'];

// penomoran otomatis NIS 
                            ...
                            <div class="col-8">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0 border-bottom ps-2" name="nis" id="nis" value="<?= $maxnis; ?>" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
