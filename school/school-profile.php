...
if ($msg == "notimage") {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
            <i class="fa-solid fa-triangle-exclamation"></i> update error, invalid file upload!
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
}
if ($msg == "oversize") {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
            <i class="fa-solid fa-triangle-exclamation"></i> update error, oversize upload file!
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
}
if ($msg == "updated") {
    $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
            <i class="fa-solid fa-circle-check"></i> Data update Success! 
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
}

// query dari database dan simpan di variable
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <form action="school-process.php" method="posts" enctype="multipart/form-data">
                <?php
                if ($msg !== '') {
                    echo $alert;
                }
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 text-center px-5">
                                <input type="hidden" name="oldImg" value="<?= $data['gambar'] ?>">
                                <img src="../assets/image/<?= $data['gambar'] ?>" alt="profile-img" class="mb-3" width="100%">
                            ...
                            <input type="hidden" name="id" id="id" value="<?= $data['id'] ?>">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -70px;">
                                        <input type="text" class="form-control border-0 border-bottom" id="name" name="name" value="<?= $data['nama'] ?>" placeholder="School Name" require>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -70px;">
                                        <textarea name="address" id="address" rows="3" class="form-control border-0 border-bottom" value="<?= $data['alamat'] ?>" placeholder="Address" require></textarea>`
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -70px;">
                                        <textarea name="visimisi" id="visimisi" rows="3" class="form-control border-0 border-bottom" value="<?= $data['visi_misi'] ?>" placeholder="Vision & Mission" require></textarea>`
                                    </div>
                                </div>
                            </div>
                        </div>
